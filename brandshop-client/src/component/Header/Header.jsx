    ...
    return (
        <div className="bg-white text-black grid grid-cols-4 items-center">
            ...
            <div className=" col-span-3 flex justify-end gap-8 mr-14">
                ...
                <Link to='/shops'><button className="border-4 border-transparent focus:border-b-red-700 font-bold text-xl py-1 hover:text-red-700 ">Shop</button></Link>
                <Link to='/features'><button className="border-4 border-transparent focus:border-b-red-700 font-bold text-xl py-1 hover:text-red-700 ">Trade/Sell</button></Link>
                <Link to='/mycart'><button className="border-4 border-transparent focus:border-b-red-700 font-bold text-xl py-1 hover:text-red-700 ">My Car</button></Link>
